...
For part 1.  WTF.....just wtf.  Ugly as hell but it works, was just going for speed result.  Also amusing was building it for the test data without even looking at the actual data, getting it working, downloading the actual data and seeing.....12 bits......Ctrl+C, Ctrl+V, Ctrl+V, Ctrl+V, Ctrl+V, Ctrl+V, Ctrl+V, Ctrl+V
